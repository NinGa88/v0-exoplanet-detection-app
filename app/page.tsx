...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-background starfield">
      {/* Hero Section */}
      <section className="container mx-auto px-4 pt-24 sm:pt-32 pb-12 sm:pb-20">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/20 mb-6 bg-[rgba(255,162,0,0.1)]">
            ...
            <span className="text-xs sm:text-sm font-medium text-accent">NASA Space Apps Challenge 2025</span>
          </div>
          ...
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-8 text-pretty leading-relaxed max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/detector" className="w-full sm:w-auto">
              <Button size="lg" className="glow-blue w-full sm:w-auto">
                Start Detecting
      ...
      <section className="container mx-auto px-4 py-12 sm:py-20">
        <div className="max-w-4xl mx-auto">
          <Card className="p-6 sm:p-12 bg-gradient-to-br from-primary/10 to-accent/10 border-primary/20">
            <div className="grid grid-cols-3 gap-4 sm:gap-8 text-center">
              <div>
                <div className="text-2xl sm:text-4xl font-bold text-primary mb-2">5,000+</div>
                <div className="text-xs sm:text-base text-muted-foreground">Confirmed Exoplanets</div>
              </div>
              <div>
                <div className="text-2xl sm:text-4xl font-bold mb-2 text-foreground">3</div>
                <div className="text-xs sm:text-base text-muted-foreground">NASA Missions</div>
              </div>
              <div>
                <div className="text-2xl sm:text-4xl font-bold text-primary mb-2">10,000+</div>
                <div className="text-xs sm:text-base text-muted-foreground">Candidates Detected</div>
              </div>
            </div>
          </Card>
        </div>
      ...
      <section className="container mx-auto px-4 py-12 sm:py-20">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">Ready to Hunt for Exoplanets?</h2>
